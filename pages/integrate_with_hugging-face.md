...
本页面介绍如何使用Milvus作为向量数据库和Hugging Face作为嵌入系统构建问答系统。
...
如果想了解本页面使用的模型和数据集，请参考[bert-base-uncased](https://huggingface.co/bert-base-uncased)和[squad](https://huggingface.co/datasets/squad)。
